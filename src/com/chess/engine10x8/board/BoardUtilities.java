...
public enum BoardUtilities {
    ...
    public final boolean[] TENTH_RANK = initRow(0);
    public final boolean[] NINTH_RANK = initRow(8);
    public final boolean[] EIGHTH_RANK = initRow(16);
    public final boolean[] SEVENTH_RANK = initRow(24);
    public final boolean[] SIXTH_RANK = initRow(32);
    public final boolean[] FIFTH_RANK = initRow(40);
    public final boolean[] FOURTH_RANK = initRow(48);
    public final boolean[] THIRD_RANK = initRow(56);
    public final boolean[] SECOND_RANK = initRow(64);
    ...
    public static final int NUM_TILES = 80;
