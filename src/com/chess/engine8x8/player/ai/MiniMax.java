...
public final class MiniMax implements MoveStrategy {
    ...
    private static class FreqTableRow {
        ...
        @Override
        public String toString() {
            return BoardUtilities.INSTANCE.getPositionAtCoordinate(this.move.getCurrentCoordinate()) +
                    BoardUtilities.INSTANCE.getPositionAtCoordinate(this.move.getDestinationCoordinate()) + " : " +this.count;
        }
    }
