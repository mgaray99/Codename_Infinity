...
import com.chess.engine9x9.pieces.*;
...
public class Board {
    ...
    public static Board createModernBoard(){
        ...
        builder.setPiece(new Archbishop(Alliance.BLACK, 3));
        builder.setPiece(new Queen(Alliance.BLACK, 4));
        builder.setPiece(new King(Alliance.BLACK, 5, true, true));
        ...
        builder.setPiece(new Rook(Alliance.WHITE, 72));
        builder.setPiece(new Knight(Alliance.WHITE, 73));
        builder.setPiece(new Bishop(Alliance.WHITE, 74));
        builder.setPiece(new Archbishop(Alliance.WHITE, 75));
        builder.setPiece(new Queen(Alliance.WHITE, 76));
        builder.setPiece(new King(Alliance.WHITE, 77, true, true));
        builder.setPiece(new Bishop(Alliance.WHITE, 78));
        builder.setPiece(new Knight(Alliance.WHITE, 79));
        builder.setPiece(new Rook(Alliance.WHITE, 80));
    ...
    public static Board createChancellorsBoard(){
        final Builder builder = new Builder();
        ...
        builder.setPiece(new Chancellor(Alliance.BLACK, 5));
        ...
        builder.setPiece(new Knight(Alliance.WHITE, 73));
        builder.setPiece(new Bishop(Alliance.WHITE, 74));
        builder.setPiece(new Queen(Alliance.WHITE, 75));
        builder.setPiece(new King(Alliance.WHITE, 76, true, true));
        builder.setPiece(new Chancellor(Alliance.WHITE, 77));
        builder.setPiece(new Knight(Alliance.WHITE, 78));
        builder.setPiece(new Bishop(Alliance.WHITE, 79));
        builder.setPiece(new Rook(Alliance.WHITE, 80));
    ...
    public static Board createMinistersBoard(){
        final Builder builder = new Builder();
        ...
        builder.setPiece(new Queen(Alliance.BLACK, 3));
        builder.setPiece(new King(Alliance.BLACK, 4, true, true));
        builder.setPiece(new Queen(Alliance.BLACK, 5));
        builder.setPiece(new Bishop(Alliance.BLACK, 6));
        builder.setPiece(new Knight(Alliance.BLACK, 7));
        builder.setPiece(new Rook(Alliance.BLACK, 8));
        builder.setPiece(new Pawn(Alliance.BLACK, 9, true));
        ...
        builder.setPiece(new Queen(Alliance.WHITE, 75));
        builder.setPiece(new King(Alliance.WHITE, 76, true, true));
        builder.setPiece(new Queen(Alliance.WHITE, 77));
        builder.setPiece(new Bishop(Alliance.WHITE, 78));
        builder.setPiece(new Knight(Alliance.WHITE, 79));
        builder.setPiece(new Rook(Alliance.WHITE, 80));
