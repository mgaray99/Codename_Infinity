...
import com.chess.engine9x9.pieces.Pawn;
import com.chess.engine9x9.pieces.Piece;
import com.chess.engine9x9.pieces.Rook;
...
public abstract class Move {
    ...
    public static class MajorAttackMove extends AttackMove{
        ...
        @Override
        public boolean equals(final Object other){
            return this == other || other instanceof Move.MajorAttackMove && super.equals(other);
        }

        @Override
        public String toString(){
            return movedPiece.getPieceType() + BoardUtilities.INSTANCE.getPositionAtCoordinate(this.destinationCoordinate);
        }
    }
    ...
    static abstract class CastleMove extends Move {
        ...
        public boolean equals(final Object other){
            ...
            if(!(other instanceof Move.CastleMove)){
                return false;
            }
            final Move.CastleMove otherCastleMove = (Move.CastleMove) other;
