...
public class Pawn extends Piece{
    ...
    private final static int[] CANDIDATE_MOVE_COORDINATE = {8, 9, 10, 18};
    ...
    public Collection<Move> calculateLegalMoves(final Board board){
        ...
        for(final int currentCandidateOffset : CANDIDATE_MOVE_COORDINATE){
            ...
            if(currentCandidateOffset == 9 && !board.getTile(candidateDestinationCoordinate).isTileOccupied()){
            ...
            } else if(currentCandidateOffset == 18 && this.isFirstMove() &&
                ...
                !board.getTile(candidateDestinationCoordinate).isTileOccupied()) {
                    ...
                    !((BoardUtilities.INSTANCE.NINTH_COLUMN[this.piecePosition] &&
            ...
            } else if(currentCandidateOffset == 10 &&
                    !((BoardUtilities.INSTANCE.FIRST_COLUMN[this.piecePosition] &&
                            this.pieceAlliance.isWhite() ) ||
                            (BoardUtilities.INSTANCE.NINTH_COLUMN[this.piecePosition] &&
                                    this.pieceAlliance.isBlack() ) ) ) {
