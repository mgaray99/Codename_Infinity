...
public class ChooseGame extends JFrame{
    ...
    public ChooseGame(){
        ...
        ActionListener menuListener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(gameMode == "Battle of Wakanda"){
                    ...
                    //Table table = new Table(gameBoard, gameMode);
                    dispose();
                }else if (gameMode == "Clash of the Avengers"){
                    gameBoard = Board.createStandardBoard();
                    if(iconMap != null) iconMap.clear();
                    iconMap = makeIconMap(gameBoard);
                    ...
                    gameBoard = Board.createHordeBoard();
                    if(iconMap != null) iconMap.clear();
                    iconMap = makeIconMap(gameBoard);
                    iconMap.put("WN", defaultPieceImagesPath + "Bruce_Banner-Hulkbuster.png");
                    table = new Table(gameBoard, gameMode);
                    ...
                    if(iconMap != null) iconMap.clear();
                    iconMap = makeIconMap(gameBoard);
                    iconMap.put("WK", defaultPieceImagesPath + "Gamora-Guardians_of_the_Galaxy.png");
                    iconMap.put("WQ", defaultPieceImagesPath + "Ms_Marvel-Captain_Marvel.png");
                    iconMap.put("WB", defaultPieceImagesPath + "Scarlet_Witch-Civil_War.png");
                    iconMap.put("WN", defaultPieceImagesPath + "Rescue.png");
                    iconMap.put("WR", defaultPieceImagesPath + "Nebula.png");
                    iconMap.put("WP", defaultPieceImagesPath + "Mantis-Modern.png");
                    table = new Table(gameBoard, gameMode);
                    //Table.setTable();
                    //Table.get().show();
                    //Table table = new Table(gameBoard, gameMode);
        ...
        String[] gameModes = {
                "Battle of New York",
                "Battle of New York: Horde",

                "Battle of Xandar",

                "Battle of Sokovia",
                "Battle of Sokovia: Horde",

                "Clash of the Avengers",

                "Battle of Wakanda",
                "Battle of Wakanda: Horde",

                "Battle of Titan",

                "Battle of Earth",
                "Battle of Earth: Horde"
                };
