...
import static com.chess.gui9x9.Table.*;
...
public class TakenPiecesPanel extends JPanel{
    ...
    public TakenPiecesPanel(String gameMode){
        ...
        if (gameMode == "Horde"){
            this.northPanel = new JPanel(new GridLayout(9, 4));
        } else {
            this.northPanel = new JPanel(new GridLayout(9, 2));
        }

        this.southPanel = new JPanel(new GridLayout(9, 2));
