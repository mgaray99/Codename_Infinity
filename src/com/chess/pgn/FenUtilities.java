...
import com.chess.engine8x8.pieces.Pawn;
...
public class FenUtilities {
    ...
    private static String calculateEnPassantSquare(final Board board){
        ...
        if(enPassantPawn != null){
            return BoardUtilities.INSTANCE.getPositionAtCoordinate(enPassantPawn.getPiecePosition() +
    ...
    private static String calculateBoardText(final Board board){
        ...
        return builder.toString()
                .replaceAll("--------", String.valueOf(8))
                .replaceAll("-------", String.valueOf(7))
                .replaceAll("------", String.valueOf(6))
                .replaceAll("-----", String.valueOf(5))
                .replaceAll("----", String.valueOf(4))
                .replaceAll("---", String.valueOf(3))
                .replaceAll("--", String.valueOf(2))
                .replaceAll("-", String.valueOf(1));
    }
}
