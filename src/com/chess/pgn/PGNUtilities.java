...
import com.chess.gui8x8.Table.MoveLog;
...
import static com.chess.engine8x8.board.Move.MoveFactory;
...
public class PGNUtilities {
    ...
    public static Move createMove(final Board board,
        ...
        if(kingSideCastleMatcher.matches()) {
            ...
            destinationCoordinate = BoardUtilities.INSTANCE.getCoordinateAtPosition(destinationSquare);
    ...
    private static int deriveCurrentCoordinate(final Board board,
        ...
        final int destinationCoordinate =  BoardUtilities.INSTANCE.getCoordinateAtPosition(destinationSquare);
        for (final Move move : board.currentPlayer().getLegalMoves()) {
    ...
    private static int extractFurther(final List<Move> candidateMoves,
        ...
        for (final Move move : currentCandidates) {
            final String pos = BoardUtilities.INSTANCE.getPositionAtCoordinate(move.getCurrentCoordinate());
